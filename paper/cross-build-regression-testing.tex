...
While we did not detect compromised builds in this experiment, our approach has revealed two cases of build configuration errors that cause subtle changes in runtime behaviour.
