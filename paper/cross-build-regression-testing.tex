...
In total there are \inputgen{num-class-pairs-after-invokevirtual-invokeinterface} pairs of classes that differ between providers, representing \inputgen{num-classes-after-invokevirtual-invokeinterface} distinct classes of interest.
...
\evosuite was applied to generate regression tests for the \textit{mvnc} version of each of these \inputgen{num-classes-after-invokevirtual-invokeinterface} distinct classes, resulting in \inputgen{num-classes-with-generated-tests} generated test classes comprising in total \inputgen{num-generated-tests} JUnit4 tests, or \inputgen{avg-tests-per-class} tests per differing class.
