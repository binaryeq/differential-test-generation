...
if [ "$JACOCO" = "" ]; then
	# Regular
	JAR_UNDER_TEST="/home/wtwhite/code/craw-redhat-oss/wget/crawl/google-aoss/io/undertow/undertow-servlet/2.2.23.Final/undertow-servlet-2.2.23.Final.jar"
else
	# Jacoco-fied jar-under-test, as well as jacocoagent itself (goes on the regular classpath)
	JAR_UNDER_TEST="/home/wtwhite/code/regression-test-generation/find-diff-classes/jacoco/lib/jacocoagent.jar:/home/wtwhite/code/regression-test-generation/find-diff-classes/jacoco/jacocofied/undertow-servlet-2.2.23.Final.jar"
fi

CLASSPATH_TO_USE="$JAR_UNDER_TEST:$DEPS:."
