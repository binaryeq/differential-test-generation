...
SELECT
    ...
    cm1.descriptor
FROM tests t1
JOIN tests t2 ON (t2.groupId, t2.artifactId, t2.version, t2.testClass) = (t1.groupId, t1.artifactId, t1.version, t1.testClass)
JOIN covered_methods cm1 ON (cm1.provider, cm1.groupId, cm1.artifactId, cm1.version, cm1.testClass) = (t1.provider, t1.groupId, t1.artifactId, t1.version, t1.testClass)
