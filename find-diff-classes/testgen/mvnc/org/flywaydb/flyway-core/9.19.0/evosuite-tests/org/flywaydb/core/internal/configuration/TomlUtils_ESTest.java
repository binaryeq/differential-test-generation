...
public class TomlUtils_ESTest extends TomlUtils_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      // Undeclared exception!
      try { 
        TomlUtils.loadConfigurationFile((File) null, "flyway_USER");
        fail("Expecting exception: NullPointerException");
  ...
  public void test06()  throws Throwable  {
      MockFile mockFile0 = new MockFile("co.fasterxml.jackson.databind.ser.impl.UnsuppotedTypeSerializer");
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // No mapper found for '.UnsuppotedTypeSerializer' extension
         //
         verifyException("org.flywaydb.core.internal.util.ObjectMapperFactory", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        TomlUtils.loadConfigurationFiles(arrayList0, "Unable to load config file: ");
        fail("Expecting exception: RuntimeException");
  ...
  public void test08()  throws Throwable  {
      MockFile mockFile0 = new MockFile("JlV\u0005", "JlV\u0005");
      // Undeclared exception!
      try { 
        TomlUtils.loadConfigurationFile(mockFile0, "JlV\u0005");
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // No mapper found for '.0/JlV\u0005/JlV\u0005' extension
         //
         verifyException("org.flywaydb.core.internal.util.ObjectMapperFactory", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("com.fasterxml.jackson.databind.ser.std.StdKeySerializer", ".");
      // Undeclared exception!
      try { 
        TomlUtils.loadConfigurationFromCommandlineArgs(hashMap0);
  ...
  public void test11()  throws Throwable  {
      ArrayList<File> arrayList0 = new ArrayList<File>();
      ConfigurationModel configurationModel0 = TomlUtils.loadConfigurationFiles(arrayList0, "Unable to load config file: ");
      assertNotNull(configurationModel0);
  }
