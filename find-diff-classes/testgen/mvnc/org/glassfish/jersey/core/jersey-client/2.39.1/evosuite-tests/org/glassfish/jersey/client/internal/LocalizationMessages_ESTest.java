...
public class LocalizationMessages_ESTest extends LocalizationMessages_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      String string0 = LocalizationMessages.USE_ENCODING_IGNORED("The entity was already written in this request. The entity can be written (serialized into the output stream) only once per a request.", "Client response resolved URI must be absolute.", object0);
  ...
  public void test001()  throws Throwable  {
      ...
      Localizable localizable0 = LocalizationMessages.localizableUSE_ENCODING_IGNORED(object0, object0, object1);
  ...
  public void test009()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableNEGATIVE_INPUT_PARAMETER("Client response resolved URI must be absolute.");
  ...
  public void test018()  throws Throwable  {
      ...
      Object object0 = new Object();
      LocalizationMessages.NEGATIVE_CHUNK_SIZE(localizable0, object0);
  ...
  public void test024()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableNONINJECT_NO_BINDING((Object) null);
  ...
  public void test026()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableWRONG_PROXY_URI_TYPE("ExceptionContext#resolve has been utilized multiple times.");
  ...
  public void test029()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableCLIENT_RX_PROVIDER_NOT_REGISTERED("No credentials are provided for basic authentication. Request will be sent without an Authorization header.");
  ...
  public void test034()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableERROR_SERVICE_LOCATOR_PROVIDER_INSTANCE_REQUEST("Unsupported password type class. Password passed in the request property must be String or byte[].");
      assertEquals("error.service.locator.provider.instance.request", localizable0.getKey());
  }

  @Test(timeout = 4000)
  public void test035()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableRESTRICTED_HEADER_PROPERTY_SETTING_FALSE("ExceptionContext#resolve has been utilized multiple times.");
  ...
  public void test041()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableERROR_LISTENER_INIT("Link of the newly created invocation must not be null.");
  ...
  public void test056()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableERROR_SHUTDOWNHOOK_CLOSE("Exceptions were thrown. See suppressed exceptions for the list.");
  ...
  public void test058()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableDIGEST_FILTER_QOP_UNSUPPORTED("Client instance has been closed.");
  ...
  public void test066()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_HTTP_METHOD_ENTITY_NOT_NULL("Client response resolved URI must not be null.");
      assertEquals("Entity must be null for http method Client response resolved URI must not be null..", string0);
  }
  ...
  public void test070()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_SHUTDOWNHOOK_CLOSE("PostInvocationInterceptor threw exception.");
      assertEquals("Client shutdown hook PostInvocationInterceptor threw exception. failed.", string0);
  }
  ...
  public void test076()  throws Throwable  {
      String string0 = LocalizationMessages.NONINJECT_UNSATISFIED("ExceptionContext#resolve has been utilized.");
      assertEquals("Unsatisfied dependency for $ExceptionContext#resolve has been utilized..", string0);
  }
  ...
  public void test085()  throws Throwable  {
      String string0 = LocalizationMessages.USING_FIXED_ASYNC_THREADPOOL("Error closing chunked inputs underlying response input stream.");
      assertEquals("Using fixed-size thread pool of size [Error closing chunked inputs underlying response input stream.] for asynchronous client invocations.", string0);
  }
  ...
  public void test089()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_SERVICE_LOCATOR_PROVIDER_INSTANCE_REQUEST("PreInvocationInterceptor utilized ClientRequestContext#abortWith.");
      assertEquals("Incorrect type of request instance PreInvocationInterceptor utilized ClientRequestContext#abortWith.. Parameter must be a default Jersey ClientRequestContext implementation.", string0);
  }
  ...
  public void test099()  throws Throwable  {
      String string0 = LocalizationMessages.NEGATIVE_INPUT_PARAMETER("Custom client SSL context, if set, must not be null.");
      assertEquals("\"Input parameter Custom client SSL context, if set, must not be null. must not be negative1.\"", string0);
  }
  ...
  public void test107()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_HTTP_METHOD_ENTITY_NULL((Object) null);
      assertEquals("Entity must not be null for http method null.", string0);
  }
  ...
  public void test109()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableERROR_SERVICE_LOCATOR_PROVIDER_INSTANCE_RESPONSE((Object) null);
  ...
  public void test112()  throws Throwable  {
      String string0 = LocalizationMessages.DIGEST_FILTER_QOP_UNSUPPORTED("Client instance has been closed.");
      assertEquals("The qop (quality of protection) = Client instance has been closed. extension requested by the server is not supported by Jersey HttpDigestAuthFilter. Cannot authenticate against the server using Http Digest Authentication.", string0);
  }
  ...
  public void test117()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableRESPONSE_TYPE_IS_NULL();
      String string0 = LocalizationMessages.NONINJECT_AMBIGUOUS_SERVICES(localizable0);
      assertEquals("Ambiguous providing services $Requested response type is null..", string0);
  }
  ...
  public void test119()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_PARAMETER_TYPE_PROCESSING("Custom trust store, if set, must not be null.");
      assertEquals("Could not process parameter type Custom trust store, if set, must not be null..", string0);
  }
