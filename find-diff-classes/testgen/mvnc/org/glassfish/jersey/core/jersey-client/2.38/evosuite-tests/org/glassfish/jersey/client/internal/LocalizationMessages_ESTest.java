...
public class LocalizationMessages_ESTest extends LocalizationMessages_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      String string0 = LocalizationMessages.USE_ENCODING_IGNORED(object1, (Object) null, object0);
  ...
  public void test002()  throws Throwable  {
      Object object0 = new Object();
      String string0 = LocalizationMessages.NEGATIVE_CHUNK_SIZE("Error during initialization of random generator of Digest authentication.", object0);
      assertNotNull(string0);
  }
  ...
  public void test003()  throws Throwable  {
      Object object0 = new Object();
      Localizable localizable0 = LocalizationMessages.localizableNEGATIVE_CHUNK_SIZE(object0, "The entity of the client request is null.");
  ...
  public void test008()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableNEGATIVE_INPUT_PARAMETER("Custom trust store, if set, must not be null.");
  ...
  public void test010()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableIGNORED_ASYNC_THREADPOOL_SIZE("Unsupported collection type.");
      assertEquals("ignored.async.threadpool.size", localizable0.getKey());
  }

  @Test(timeout = 4000)
  public void test011()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableERROR_HTTP_METHOD_ENTITY_NOT_NULL((Object) null);
  ...
  public void test021()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableCLIENT_RX_PROVIDER_NOT_REGISTERED("ExceptionContext#resolve has been utilized multiple times.");
  ...
  public void test050()  throws Throwable  {
      ...
      assertEquals("Client shutdown hook Invocation builder must not be null. failed.", string0);
  }
  ...
  public void test058()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_HTTP_METHOD_ENTITY_NOT_NULL("Credentials must be defined for basic authentication. Define username and password either when creating HttpAuthenticationFeature or use specific credentials for each request using the request property (see HttpAuthenticationFeature).");
      assertEquals("Entity must be null for http method Credentials must be defined for basic authentication. Define username and password either when creating HttpAuthenticationFeature or use specific credentials for each request using the request property (see HttpAuthenticationFeature)..", string0);
  }
  ...
  public void test063()  throws Throwable  {
      ...
      assertEquals("Restricted headers are not enabled using [URI builder of the newly created target must not be null.] system property (setting only takes effect on connections created after the property has been set/changed).", string0);
  }
  ...
  public void test076()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableWRONG_PROXY_URI_TYPE("Entity must not be null for http method java.lang.Object@2972974e.");
      LocalizationMessages.NULL_INPUT_PARAMETER(localizable0);
      assertEquals("wrong.proxy.uri.type", localizable0.getKey());
  }

  @Test(timeout = 4000)
  public void test077()  throws Throwable  {
      String string0 = LocalizationMessages.USING_FIXED_ASYNC_THREADPOOL("No credentials are provided for basic authentication. Request will be sent without an Authorization header.");
      assertEquals("Using fixed-size thread pool of size [No credentials are provided for basic authentication. Request will be sent without an Authorization header.] for asynchronous client invocations.", string0);
  }
  ...
  public void test080()  throws Throwable  {
      ...
      LocalizationMessages.ERROR_SERVICE_LOCATOR_PROVIDER_INSTANCE_REQUEST(localizable0);
  ...
  public void test081()  throws Throwable  {
      ...
      assertEquals("The proxy URI (\"Error when closing the output stream.\") property MUST be an instance of String or URI.", string0);
  }
  ...
  public void test087()  throws Throwable  {
      Object object0 = new Object();
      String string0 = LocalizationMessages.NEGATIVE_INPUT_PARAMETER(object0);
      assertNotNull(string0);
  }
  ...
  public void test099()  throws Throwable  {
      ...
      assertEquals("The qop (quality of protection) = Error when closing the output stream. extension requested by the server is not supported by Jersey HttpDigestAuthFilter. Cannot authenticate against the server using Http Digest Authentication.", string0);
  }
  ...
  public void test101()  throws Throwable  {
      ...
      String string0 = LocalizationMessages.ERROR_SERVICE_LOCATOR_PROVIDER_INSTANCE_RESPONSE(localizable0);
      assertEquals("Incorrect type of response instance Error while committing the request output stream.. Parameter must be a default Jersey ClientResponseContext implementation.", string0);
  }
  ...
  public void test111()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_LISTENER_INIT("Client instance has been closed.");
      assertEquals("ClientLifecycleListener Client instance has been closed. failed to initialize properly.", string0);
  }
