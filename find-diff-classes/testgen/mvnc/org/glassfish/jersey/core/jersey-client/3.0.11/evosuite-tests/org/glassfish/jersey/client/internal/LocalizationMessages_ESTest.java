...
public class LocalizationMessages_ESTest extends LocalizationMessages_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      LocalizationMessages.USE_ENCODING_IGNORED(object0, localizable0, object1);
  ...
  public void test008()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableNEGATIVE_INPUT_PARAMETER("URI of the newly created target must not be null.");
  ...
  public void test011()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableIGNORED_ASYNC_THREADPOOL_SIZE("Credentials must be defined for basic authentication. Define username and password either when creating HttpAuthenticationFeature or use specific credentials for each request using the request property (see HttpAuthenticationFeature).");
      Localizable localizable1 = LocalizationMessages.localizableERROR_HTTP_METHOD_ENTITY_NOT_NULL(localizable0);
      assertEquals("ignored.async.threadpool.size", localizable0.getKey());
      assertEquals("error.http.method.entity.not.null", localizable1.getKey());
  }
  ...
  public void test014()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableNEGATIVE_CHUNK_SIZE("Chunked input has been closed already.", "Chunked input has been closed already.");
      assertEquals("negative.chunk.size", localizable0.getKey());
  }

  @Test(timeout = 4000)
  public void test015()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableSNI_URI_REPLACED("Requested response type is null.", "Requested response type is null.");
  ...
  public void test017()  throws Throwable  {
      ...
      Localizable localizable1 = LocalizationMessages.localizableNONINJECT_NO_CONSTRUCTOR(localizable0);
      assertEquals("client.target.link.null", localizable0.getKey());
      assertEquals("noninject.no.constructor", localizable1.getKey());
  }
  ...
  public void test019()  throws Throwable  {
      Object object0 = new Object();
      Localizable localizable0 = LocalizationMessages.localizableNONINJECT_NO_BINDING(object0);
      assertEquals("noninject.no.binding", localizable0.getKey());
  }

  @Test(timeout = 4000)
  public void test020()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableUSE_ENCODING_IGNORED("Error during initialization of random generator of Digest authentication.", "Error during initialization of random generator of Digest authentication.", "Error during initialization of random generator of Digest authentication.");
  ...
  public void test022()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableWRONG_PROXY_URI_TYPE("PreInvocationInterceptor threw exception.");
  ...
  public void test024()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableCLIENT_RX_PROVIDER_NOT_REGISTERED("The entity of the client request is null.");
  ...
  public void test035()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableUSING_FIXED_ASYNC_THREADPOOL("Credentials must be defined for basic authentication. Define username and password either when creating HttpAuthenticationFeature or use specific credentials for each request using the request property (see HttpAuthenticationFeature).");
  ...
  public void test042()  throws Throwable  {
      Object object0 = new Object();
      Localizable localizable0 = LocalizationMessages.localizableNONINJECT_UNSATISFIED(object0);
  ...
  public void test051()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableERROR_SHUTDOWNHOOK_CLOSE("Client response resolved URI must not be null.");
  ...
  public void test054()  throws Throwable  {
      ...
      assertEquals("Updating SSLParameters for SNIServerName=PostInvocationInterceptor threw exception..", string0);
  }
  ...
  public void test060()  throws Throwable  {
      String string0 = LocalizationMessages.SNI_URI_REPLACED("Requested response type is null.", (Object) null);
      assertEquals("HTTP Request sent with request to IP address Requested response type is null. rather than the hostname null.", string0);
  }
  ...
  public void test063()  throws Throwable  {
      ...
      String string0 = LocalizationMessages.ERROR_HTTP_METHOD_ENTITY_NOT_NULL(localizable0);
      assertEquals("Entity must be null for http method The entity of the client request is null..", string0);
  }

  @Test(timeout = 4000)
  public void test064()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_HTTP_METHOD_ENTITY_NULL("No credentials are provided for basic authentication. Request will be sent without an Authorization header.");
      assertEquals("Entity must not be null for http method No credentials are provided for basic authentication. Request will be sent without an Authorization header..", string0);
  }
  ...
  public void test070()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_SHUTDOWNHOOK_CLOSE("Error during initialization of random generator of Digest authentication.");
      assertEquals("Client shutdown hook Error during initialization of random generator of Digest authentication. failed.", string0);
  }
  ...
  public void test075()  throws Throwable  {
      String string0 = LocalizationMessages.NONINJECT_UNSATISFIED("URI template of the newly created target must not be null.");
      assertEquals("Unsatisfied dependency for $URI template of the newly created target must not be null..", string0);
  }
  ...
  public void test081()  throws Throwable  {
      ...
      String string0 = LocalizationMessages.IGNORED_ASYNC_THREADPOOL_SIZE(localizable0);
      assertEquals("Zero or negative asynchronous thread pool size specified in the client configuration property: [Error during initialization of random generator of Digest authentication.] Using default cached thread pool.", string0);
  }

  @Test(timeout = 4000)
  public void test082()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableCLIENT_INSTANCE_CLOSED();
      String string0 = LocalizationMessages.RESTRICTED_HEADER_PROPERTY_SETTING_TRUE(localizable0);
      assertEquals("Restricted headers are enabled using [Client instance has been closed.] system property(setting only takes effect onconnections created after the property has been set/changed).", string0);
  }

  @Test(timeout = 4000)
  public void test083()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableCLIENT_INSTANCE_CLOSED();
      String string0 = LocalizationMessages.NULL_INPUT_PARAMETER(localizable0);
      assertEquals("Input method parameter Client instance has been closed. must not be null.", string0);
  }
  ...
  public void test085()  throws Throwable  {
      Object object0 = new Object();
      String string0 = LocalizationMessages.USING_FIXED_ASYNC_THREADPOOL(object0);
      assertNotNull(string0);
  }
  ...
  public void test087()  throws Throwable  {
      ...
      LocalizationMessages.ERROR_LISTENER_CLOSE(localizable0);
  ...
  public void test090()  throws Throwable  {
      ...
      String string0 = LocalizationMessages.ERROR_SERVICE_LOCATOR_PROVIDER_INSTANCE_REQUEST(localizable0);
      assertEquals("Incorrect type of request instance Invocation builder must not be null.. Parameter must be a default Jersey ClientRequestContext implementation.", string0);
  }
  ...
  public void test099()  throws Throwable  {
      String string0 = LocalizationMessages.NEGATIVE_INPUT_PARAMETER("URI of the newly created target must not be null.");
      assertEquals("\"Input parameter URI of the newly created target must not be null. must not be negative1.\"", string0);
  }
  ...
  public void test105()  throws Throwable  {
      String string0 = LocalizationMessages.CLIENT_RX_PROVIDER_NOT_REGISTERED("Falling back to injection-less client.");
      assertEquals("RxInvokerProvider for type Falling back to injection-less client. is not registered.", string0);
  }
  ...
  public void test107()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableCLIENT_INSTANCE_CLOSED();
      Localizable localizable1 = LocalizationMessages.localizableERROR_HTTP_METHOD_ENTITY_NULL(localizable0);
      assertEquals("error.http.method.entity.null", localizable1.getKey());
  ...
  public void test109()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_SERVICE_LOCATOR_PROVIDER_INSTANCE_RESPONSE("Specified chunk media type must not be null.");
      assertEquals("Incorrect type of response instance Specified chunk media type must not be null.. Parameter must be a default Jersey ClientResponseContext implementation.", string0);
  }
  ...
  public void test112()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableSNI_UPDATE_SSLPARAMS("No binding found for $java.lang.Object@2e368fbc.");
  ...
  public void test114()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableDIGEST_FILTER_QOP_UNSUPPORTED("ExecutorService must not be set to null.");
  ...
  public void test118()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableCLIENT_TARGET_LINK_NULL();
      String string0 = LocalizationMessages.RESTRICTED_HEADER_PROPERTY_SETTING_FALSE(localizable0);
      assertEquals("Restricted headers are not enabled using [Link to the newly created target must not be null.] system property (setting only takes effect on connections created after the property has been set/changed).", string0);
  }
  ...
  public void test120()  throws Throwable  {
      String string0 = LocalizationMessages.NONINJECT_AMBIGUOUS_SERVICES("No credentials are provided for basic authentication. Request will be sent without an Authorization header.");
      assertEquals("Ambiguous providing services $No credentials are provided for basic authentication. Request will be sent without an Authorization header..", string0);
  }
  ...
  public void test122()  throws Throwable  {
      Object object0 = new Object();
      String string0 = LocalizationMessages.ERROR_PARAMETER_TYPE_PROCESSING(object0);
      assertNotNull(string0);
  }

  @Test(timeout = 4000)
  public void test123()  throws Throwable  {
      String string0 = LocalizationMessages.NONINJECT_NO_CONSTRUCTOR("Client instance has been closed.");
      assertEquals("No applicable constructor for $Client instance has been closed. found.", string0);
  }
  ...
  public void test130()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_LISTENER_INIT("Falling back to injection-less client.");
      assertEquals("ClientLifecycleListener Falling back to injection-less client. failed to initialize properly.", string0);
  }
