...
public class LocalizationMessages_ESTest extends LocalizationMessages_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      Localizable localizable1 = LocalizationMessages.localizableUSE_ENCODING_IGNORED(localizable0, "Custom trust store, if set, must not be null.", localizable0);
  ...
  public void test004()  throws Throwable  {
      ...
      Localizable localizable1 = LocalizationMessages.localizableNULL_INPUT_PARAMETER(localizable0);
      assertEquals("exception.suppressed", localizable0.getKey());
      assertEquals("null.input.parameter", localizable1.getKey());
  }
  ...
  public void test006()  throws Throwable  {
      Object object0 = new Object();
      Localizable localizable0 = LocalizationMessages.localizableNEGATIVE_INPUT_PARAMETER(object0);
  ...
  public void test010()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableERROR_HTTP_METHOD_ENTITY_NOT_NULL("Client response status must not be null.");
  ...
  public void test015()  throws Throwable  {
      ...
      Localizable localizable1 = LocalizationMessages.localizableNEGATIVE_CHUNK_SIZE((Object) null, localizable0);
  ...
  public void test020()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableWRONG_PROXY_URI_TYPE("PostInvocationInterceptor threw exception.");
  ...
  public void test025()  throws Throwable  {
      ...
      Object object0 = new Object();
      LocalizationMessages.USE_ENCODING_IGNORED(object0, "PreInvocationInterceptor utilized ClientRequestContext#abortWith.", localizable0);
  ...
  public void test030()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableUSING_FIXED_ASYNC_THREADPOOL("Error when closing the output stream.");
  ...
  public void test057()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_HTTP_METHOD_ENTITY_NOT_NULL("Client response status must not be null.");
      assertEquals("Entity must be null for http method Client response status must not be null..", string0);
  }
  ...
  public void test071()  throws Throwable  {
      ...
      assertEquals("Zero or negative asynchronous thread pool size specified in the client configuration property: [Credentials must be defined for basic authentication. Define username and password either when creating HttpAuthenticationFeature or use specific credentials for each request using the request property (see HttpAuthenticationFeature).] Using default cached thread pool.", string0);
  }
  ...
  public void test075()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_LISTENER_CLOSE((Object) null);
      assertEquals("ClientLifecycleListener null failed to close properly.", string0);
  }
  ...
  public void test077()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_SERVICE_LOCATOR_PROVIDER_INSTANCE_REQUEST("PostInvocationInterceptor threw exception.");
      assertEquals("Incorrect type of request instance PostInvocationInterceptor threw exception.. Parameter must be a default Jersey ClientRequestContext implementation.", string0);
  }
  ...
  public void test078()  throws Throwable  {
      ...
      assertEquals("The proxy URI (\"Exceptions were thrown. See suppressed exceptions for the list.\") property MUST be an instance of String or URI.", string0);
  }
  ...
  public void test085()  throws Throwable  {
      String string0 = LocalizationMessages.NEGATIVE_INPUT_PARAMETER("The entity of the client request is null.");
      assertEquals("\"Input parameter The entity of the client request is null. must not be negative.\"", string0);
  }
  ...
  public void test092()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableCLIENT_RX_PROVIDER_NOT_REGISTERED("ExecutorService must not be set to null.");
  ...
  public void test094()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableERROR_HTTP_METHOD_ENTITY_NULL("PreInvocationInterceptor utilized ClientRequestContext#abortWith.");
  ...
  public void test099()  throws Throwable  {
      ...
      assertEquals("The qop (quality of protection) = URI template of the newly created target must not be null. extension requested by the server is not supported by Jersey HttpDigestAuthFilter. Cannot authenticate against the server using Http Digest Authentication.", string0);
  }
  ...
  public void test102()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableRESTRICTED_HEADER_PROPERTY_SETTING_FALSE("The entity was already written in this request. The entity can be written (serialized into the output stream) only once per a request.");
  ...
  public void test105()  throws Throwable  {
      ...
      assertEquals("Could not process parameter type PreInvocationInterceptor utilized ClientRequestContext#abortWith..", string0);
  }
