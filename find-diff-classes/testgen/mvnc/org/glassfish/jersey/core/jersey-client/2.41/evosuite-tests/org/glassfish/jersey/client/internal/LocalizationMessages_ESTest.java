...
public class LocalizationMessages_ESTest extends LocalizationMessages_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      String string0 = LocalizationMessages.SNI_URI_REPLACED(object0, "Attempt to send restricted header(s) while the [\"Input parameter java.lang.Object@313860ff must not be negative1.\"] system property not set. Header(s) will possibly be ignored.");
  ...
  public void test001()  throws Throwable  {
      ...
      Localizable localizable0 = LocalizationMessages.localizableSNI_URI_REPLACED(object0, object1);
  ...
  public void test009()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableNEGATIVE_INPUT_PARAMETER("Chunked input has been closed already.");
  ...
  public void test013()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableIGNORED_ASYNC_THREADPOOL_SIZE("Custom client SSL context, if set, must not be null.");
      assertEquals("ignored.async.threadpool.size", localizable0.getKey());
  }

  @Test(timeout = 4000)
  public void test014()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableERROR_HTTP_METHOD_ENTITY_NULL("Detected non-empty entity on a HTTP GET request. The underlying HTTP transport connector may decide to change the request method to POST.");
  ...
  public void test018()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableERROR_SERVICE_LOCATOR_PROVIDER_INSTANCE_RESPONSE("Unexpected error during response processing.");
      assertEquals("error.service.locator.provider.instance.response", localizable0.getKey());
  }

  @Test(timeout = 4000)
  public void test019()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableSNI_UPDATE_SSLPARAMS("Attempt to send restricted header(s) while the [java.lang.Object@1a03b4d7] system property not set. Header(s) will possibly be ignored.");
  ...
  public void test025()  throws Throwable  {
      Object object0 = new Object();
      Localizable localizable0 = LocalizationMessages.localizableUSE_ENCODING_IGNORED(object0, object0, object0);
  ...
  public void test046()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableNONINJECT_UNSATISFIED("Detected non-empty entity on a HTTP GET request. The underlying HTTP transport connector may decide to change the request method to POST.");
  ...
  public void test053()  throws Throwable  {
      Object object0 = new Object();
      Localizable localizable0 = LocalizationMessages.localizableRESTRICTED_HEADER_PROPERTY_SETTING_TRUE(object0);
  ...
  public void test054()  throws Throwable  {
      Object object0 = new Object();
      Localizable localizable0 = LocalizationMessages.localizableNONINJECT_AMBIGUOUS_SERVICES(object0);
      Localizable localizable1 = LocalizationMessages.localizableNONINJECT_UNSATISFIED(object0);
      LocalizationMessages.NEGATIVE_CHUNK_SIZE(localizable1, localizable0);
  ...
  public void test057()  throws Throwable  {
      Object object0 = new Object();
      Localizable localizable0 = LocalizationMessages.localizableERROR_SHUTDOWNHOOK_CLOSE(object0);
  ...
  public void test059()  throws Throwable  {
      Object object0 = new Object();
      Localizable localizable0 = LocalizationMessages.localizableRESTRICTED_HEADER_POSSIBLY_IGNORED(object0);
  ...
  public void test064()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_HTTP_METHOD_ENTITY_NOT_NULL("PreInvocationInterceptor threw exception.");
      assertEquals("Entity must be null for http method PreInvocationInterceptor threw exception..", string0);
  }
  ...
  public void test067()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableERROR_HTTP_METHOD_ENTITY_NOT_NULL("ClientLifecycleListener java.lang.Object@6a350bb5 failed to close properly.");
  ...
  public void test071()  throws Throwable  {
      ...
      String string0 = LocalizationMessages.ERROR_SHUTDOWNHOOK_CLOSE(localizable0);
      assertEquals("Client shutdown hook Request cancelled by the client call. failed.", string0);
  }

  @Test(timeout = 4000)
  public void test072()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_PARAMETER_TYPE_PROCESSING("Detected non-empty entity on a HTTP GET request. The underlying HTTP transport connector may decide to change the request method to POST.");
      assertEquals("Could not process parameter type Detected non-empty entity on a HTTP GET request. The underlying HTTP transport connector may decide to change the request method to POST..", string0);
  }
  ...
  public void test074()  throws Throwable  {
      Object object0 = new Object();
      String string0 = LocalizationMessages.USE_ENCODING_IGNORED(object0, object0, (Object) null);
      assertNotNull(string0);
  }
  ...
  public void test078()  throws Throwable  {
      String string0 = LocalizationMessages.NONINJECT_UNSATISFIED("Unsupported collection type.");
      assertEquals("Unsatisfied dependency for $Unsupported collection type..", string0);
  }
  ...
  public void test084()  throws Throwable  {
      String string0 = LocalizationMessages.RESTRICTED_HEADER_PROPERTY_SETTING_TRUE("Credentials must be defined for digest authentication. Define username and password either when creating HttpAuthenticationFeature or use specific credentials for each request using the request property (see HttpAuthenticationFeature).");
      assertEquals("Restricted headers are enabled using [Credentials must be defined for digest authentication. Define username and password either when creating HttpAuthenticationFeature or use specific credentials for each request using the request property (see HttpAuthenticationFeature).] system property(setting only takes effect onconnections created after the property has been set/changed).", string0);
  }
  ...
  public void test088()  throws Throwable  {
      String string0 = LocalizationMessages.USING_FIXED_ASYNC_THREADPOOL("ConnectorProvider must not be set to null.");
      assertEquals("Using fixed-size thread pool of size [ConnectorProvider must not be set to null.] for asynchronous client invocations.", string0);
  }
  ...
  public void test093()  throws Throwable  {
      String string0 = LocalizationMessages.WRONG_PROXY_URI_TYPE("Unexpected error during response processing.");
      assertEquals("The proxy URI (\"Unexpected error during response processing.\") property MUST be an instance of String or URI.", string0);
  }
  ...
  public void test098()  throws Throwable  {
      ...
      String string0 = LocalizationMessages.NONINJECT_NO_BINDING(localizable0);
      assertEquals("No binding found for $InjectionManager is already shutdown..", string0);
  }
  ...
  public void test101()  throws Throwable  {
      ...
      assertEquals("\"Input parameter Link to the newly created target must not be null. must not be negative1.\"", string0);
  }
  ...
  public void test110()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_HTTP_METHOD_ENTITY_NULL("Error when closing the output stream.");
      assertEquals("Entity must not be null for http method Error when closing the output stream..", string0);
  }
  ...
  public void test112()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_SERVICE_LOCATOR_PROVIDER_INSTANCE_RESPONSE("Chunked input has been closed already.");
      assertEquals("Incorrect type of response instance Chunked input has been closed already.. Parameter must be a default Jersey ClientResponseContext implementation.", string0);
  }
  ...
  public void test114()  throws Throwable  {
      String string0 = LocalizationMessages.DIGEST_FILTER_QOP_UNSUPPORTED("PostInvocationInterceptor threw exception.");
      assertEquals("The qop (quality of protection) = PostInvocationInterceptor threw exception. extension requested by the server is not supported by Jersey HttpDigestAuthFilter. Cannot authenticate against the server using Http Digest Authentication.", string0);
  }
  ...
  public void test115()  throws Throwable  {
      ...
      assertEquals("Updating SSLParameters for SNIServerName=Request cancelled by the client call..", string0);
  }
  ...
  public void test116()  throws Throwable  {
      ...
      assertEquals("Incorrect type of request instance The entity was already written in this request. The entity can be written (serialized into the output stream) only once per a request.. Parameter must be a default Jersey ClientRequestContext implementation.", string0);
  }
  ...
  public void test121()  throws Throwable  {
      ...
      assertEquals("Restricted headers are not enabled using [Exceptions were thrown. See suppressed exceptions for the list.] system property (setting only takes effect on connections created after the property has been set/changed).", string0);
  }
  ...
  public void test123()  throws Throwable  {
      Object object0 = new Object();
      String string0 = LocalizationMessages.NONINJECT_AMBIGUOUS_SERVICES(object0);
      assertNotNull(string0);
  }
  ...
  public void test126()  throws Throwable  {
      Object object0 = new Object();
      String string0 = LocalizationMessages.NONINJECT_NO_CONSTRUCTOR(object0);
      assertNotNull(string0);
  }
