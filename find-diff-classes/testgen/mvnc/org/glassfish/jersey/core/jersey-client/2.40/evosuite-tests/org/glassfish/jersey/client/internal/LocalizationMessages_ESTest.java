...
public class LocalizationMessages_ESTest extends LocalizationMessages_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      String string0 = LocalizationMessages.SNI_URI_REPLACED("The entity of the client request is null.", object0);
  ...
  public void test001()  throws Throwable  {
      ...
      Localizable localizable1 = LocalizationMessages.localizableSNI_URI_REPLACED(object0, localizable0);
      assertEquals("sni.uri.replaced", localizable1.getKey());
  ...
  public void test002()  throws Throwable  {
      ...
      LocalizationMessages.USE_ENCODING_IGNORED(object1, object0, localizable0);
  ...
  public void test003()  throws Throwable  {
      ...
      LocalizationMessages.NEGATIVE_CHUNK_SIZE(object0, localizable0);
  ...
  public void test006()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableNULL_INPUT_PARAMETER("Custom key store, if set, must not be null.");
  ...
  public void test011()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableIGNORED_ASYNC_THREADPOOL_SIZE("ExceptionContext#resolve has been utilized.");
  ...
  public void test016()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableERROR_SERVICE_LOCATOR_PROVIDER_INSTANCE_RESPONSE("Failed to convert a response into an exception.");
  ...
  public void test024()  throws Throwable  {
      ...
      Localizable localizable1 = LocalizationMessages.localizableUSE_ENCODING_IGNORED(localizable0, localizable0, "Custom key store, if set, must not be null.");
  ...
  public void test026()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableWRONG_PROXY_URI_TYPE("The entity of the client request is null.");
  ...
  public void test028()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableCLIENT_RX_PROVIDER_NOT_REGISTERED("URI template of the newly created target must not be null.");
  ...
  public void test035()  throws Throwable  {
      Object object0 = new Object();
      Localizable localizable0 = LocalizationMessages.localizableUSING_FIXED_ASYNC_THREADPOOL(object0);
      Localizable localizable1 = LocalizationMessages.localizableRESTRICTED_HEADER_PROPERTY_SETTING_FALSE(localizable0);
      assertEquals("restricted.header.property.setting.false", localizable1.getKey());
      assertEquals("using.fixed.async.threadpool", localizable0.getKey());
  }
  ...
  public void test060()  throws Throwable  {
      ...
      Localizable localizable1 = LocalizationMessages.localizableSNI_UPDATE_SSLPARAMS(localizable0);
      assertEquals("sni.update.sslparams", localizable1.getKey());
  ...
  public void test071()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableERROR_HTTP_METHOD_ENTITY_NOT_NULL("Credentials must be defined for basic authentication. Define username and password either when creating HttpAuthenticationFeature or use specific credentials for each request using the request property (see HttpAuthenticationFeature).");
  ...
  public void test075()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_SHUTDOWNHOOK_CLOSE("Error while committing the request output stream.");
      assertEquals("Client shutdown hook Error while committing the request output stream. failed.", string0);
  }
  ...
  public void test081()  throws Throwable  {
      String string0 = LocalizationMessages.NONINJECT_UNSATISFIED("ExceptionContext#resolve has been utilized multiple times.");
      assertEquals("Unsatisfied dependency for $ExceptionContext#resolve has been utilized multiple times..", string0);
  }
  ...
  public void test086()  throws Throwable  {
      String string0 = LocalizationMessages.IGNORED_ASYNC_THREADPOOL_SIZE("Custom key store, if set, must not be null.");
      assertEquals("Zero or negative asynchronous thread pool size specified in the client configuration property: [Custom key store, if set, must not be null.] Using default cached thread pool.", string0);
  }

  @Test(timeout = 4000)
  public void test087()  throws Throwable  {
      String string0 = LocalizationMessages.RESTRICTED_HEADER_PROPERTY_SETTING_TRUE("Error when closing the output stream.");
      assertEquals("Restricted headers are enabled using [Error when closing the output stream.] system property(setting only takes effect onconnections created after the property has been set/changed).", string0);
  }
  ...
  public void test090()  throws Throwable  {
      String string0 = LocalizationMessages.USING_FIXED_ASYNC_THREADPOOL("The entity of the client request is null.");
      assertEquals("Using fixed-size thread pool of size [The entity of the client request is null.] for asynchronous client invocations.", string0);
  }
  ...
  public void test095()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_SERVICE_LOCATOR_PROVIDER_INSTANCE_REQUEST("Setting SNIServerName on SSLEngine");
      assertEquals("Incorrect type of request instance Setting SNIServerName on SSLEngine. Parameter must be a default Jersey ClientRequestContext implementation.", string0);
  }

  @Test(timeout = 4000)
  public void test096()  throws Throwable  {
      String string0 = LocalizationMessages.WRONG_PROXY_URI_TYPE("Request cancelled by the client call.");
      assertEquals("The proxy URI (\"Request cancelled by the client call.\") property MUST be an instance of String or URI.", string0);
  }
  ...
  public void test101()  throws Throwable  {
      String string0 = LocalizationMessages.NONINJECT_NO_BINDING("Unsupported password type class. Password passed in the request property must be String or byte[].");
      assertEquals("No binding found for $Unsupported password type class. Password passed in the request property must be String or byte[]..", string0);
  }
  ...
  public void test104()  throws Throwable  {
      String string0 = LocalizationMessages.NEGATIVE_INPUT_PARAMETER("URI template of the newly created target must not be null.");
      assertEquals("\"Input parameter URI template of the newly created target must not be null. must not be negative1.\"", string0);
  }
  ...
  public void test110()  throws Throwable  {
      ...
      assertEquals("RxInvokerProvider for type URI template of the newly created target must not be null. is not registered.", string0);
  }
  ...
  public void test114()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_SERVICE_LOCATOR_PROVIDER_INSTANCE_RESPONSE("RxInvokerProvider returned null.");
      assertEquals("Incorrect type of response instance RxInvokerProvider returned null.. Parameter must be a default Jersey ClientResponseContext implementation.", string0);
  }
  ...
  public void test116()  throws Throwable  {
      String string0 = LocalizationMessages.DIGEST_FILTER_QOP_UNSUPPORTED("The entity of the client request is null.");
      assertEquals("The qop (quality of protection) = The entity of the client request is null. extension requested by the server is not supported by Jersey HttpDigestAuthFilter. Cannot authenticate against the server using Http Digest Authentication.", string0);
  }

  @Test(timeout = 4000)
  public void test117()  throws Throwable  {
      Object object0 = new Object();
      String string0 = LocalizationMessages.SNI_UPDATE_SSLPARAMS(object0);
      assertNotNull(string0);
  }
  ...
  public void test119()  throws Throwable  {
      Localizable localizable0 = LocalizationMessages.localizableDIGEST_FILTER_QOP_UNSUPPORTED((Object) null);
  ...
  public void test125()  throws Throwable  {
      String string0 = LocalizationMessages.NONINJECT_AMBIGUOUS_SERVICES("Client instance has been closed.");
      assertEquals("Ambiguous providing services $Client instance has been closed..", string0);
  }
  ...
  public void test127()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_PARAMETER_TYPE_PROCESSING("Specified chunk media type must not be null.");
      assertEquals("Could not process parameter type Specified chunk media type must not be null..", string0);
  }

  @Test(timeout = 4000)
  public void test128()  throws Throwable  {
      String string0 = LocalizationMessages.NONINJECT_NO_CONSTRUCTOR("The entity of the client request is null.");
      assertEquals("No applicable constructor for $The entity of the client request is null. found.", string0);
  }
  ...
  public void test135()  throws Throwable  {
      String string0 = LocalizationMessages.ERROR_LISTENER_INIT("ExecutorService must not be set to null.");
      assertEquals("ClientLifecycleListener ExecutorService must not be set to null. failed to initialize properly.", string0);
  }
