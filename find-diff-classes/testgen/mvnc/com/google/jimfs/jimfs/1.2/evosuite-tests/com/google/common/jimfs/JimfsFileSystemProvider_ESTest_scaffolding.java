...
public class JimfsFileSystemProvider_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.google.common.jimfs.JimfsFileSystemProvider"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(JimfsFileSystemProvider_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.google.common.collect.DiscreteDomain", false, JimfsFileSystemProvider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.nio.file.DirectoryStream$Filter", false, JimfsFileSystemProvider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.nio.file.attribute.FileAttribute", false, JimfsFileSystemProvider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.ToDoubleFunction", false, JimfsFileSystemProvider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.ToLongFunction", false, JimfsFileSystemProvider_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(JimfsFileSystemProvider_ESTest_scaffolding.class.getClassLoader()); 
