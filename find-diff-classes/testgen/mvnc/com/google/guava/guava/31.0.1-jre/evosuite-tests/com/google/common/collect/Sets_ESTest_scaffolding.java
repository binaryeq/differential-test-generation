...
public class Sets_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.google.common.collect.Sets"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.google.common.collect.DiscreteDomain", false, Sets_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.common.hash.Funnel", false, Sets_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.lang.Comparable", false, Sets_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Comparator", false, Sets_ESTest_scaffolding.class.getClassLoader()));
  }
