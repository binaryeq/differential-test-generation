...
public class Futures_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.google.common.util.concurrent.Futures"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Futures_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.google.common.util.concurrent.AsyncCallable", false, Futures_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.common.util.concurrent.AsyncFunction", false, Futures_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.lang.ThreadGroup", false, Futures_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Comparator", false, Futures_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.concurrent.Callable", false, Futures_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.concurrent.ThreadFactory", false, Futures_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiFunction", false, Futures_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Futures_ESTest_scaffolding.class.getClassLoader()); 
